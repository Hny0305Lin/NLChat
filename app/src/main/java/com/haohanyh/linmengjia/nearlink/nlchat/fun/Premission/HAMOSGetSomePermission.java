...
public class HAMOSGetSomePermission {
    ...
    public static final class Permission {
        ...
        private static final List<String> ListPhoto = new ArrayList<>(3);
        ...
        public static final class Photo {
            public static final String PERMISSION_GRANTED = Manifest.permission.CAMERA;
        }
        ...
        static {
            ...
            //需要获取拍照权限
            ListPhoto.add(Photo.PERMISSION_GRANTED);
        }
    }
